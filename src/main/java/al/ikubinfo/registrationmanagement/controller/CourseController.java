...
public class CourseController {
    ...
    public ResponseEntity<List<CourseUserDto>> getStudentsByCourseId(@PathVariable Long id) {
        return new ResponseEntity<>(courseService.getAllStudentsByCourseId(id), HttpStatus.ACCEPTED);
